...
import { FolderKanban, FileText, MessageSquareText, User } from "lucide-react";
...
export default function Header({ activeView, onViewChange }: HeaderProps) {
  ...
  return (
    <header className="portfolio-topbar fixed top-0 left-0 right-0 2xl:right-[300px] h-16 bg-black/45 backdrop-blur-xl border-b border-x border-white/10 z-40 flex items-center justify-start select-none shadow-sm shadow-black/25 overflow-hidden">
      ...
      <div className="compact-nav-1200 relative z-10 grid grid-cols-4 w-full h-full">

      ...
      <div className="relative z-10 w-full space-y-4 xl:space-y-5">
        ...
        <div className="flex flex-col items-center text-center space-y-2.5">
          ...
          <div className="space-y-1">
            <h1 className="font-mono text-xl xl:text-2xl text-white font-medium tracking-tight">
              {PERSONAL_BIO.fullName}
              <span className="text-[#fbbc04] font-mono text-xs font-light"> .info</span>
            </h1>
            <p className="font-mono text-[13px] text-[#8e9196] tracking-wider uppercase">
              {PERSONAL_BIO.title}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2 text-left">
          ...
          <div className="p-4 rounded-xl border border-white/5 bg-white/[0.01]">
            <p className="font-mono text-[13px] xl:text-sm text-neutral-300 leading-5 xl:leading-6 font-light">
        ...
        <div className="space-y-2.5 text-left">
          ...
          <ul className="space-y-2.5 xl:space-y-3 font-mono text-[13px] xl:text-sm text-neutral-300 font-light">
